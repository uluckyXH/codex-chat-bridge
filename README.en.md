...
- The `weixin codex` daemon terminal prints inbound Weixin messages, outbound Codex replies, and media sends in a chat-style transcript so the running conversation can be observed locally.
